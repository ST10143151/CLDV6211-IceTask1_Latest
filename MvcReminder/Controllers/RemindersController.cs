...
namespace MvcReminder.Controllers
{
    ...
    {
        private readonly MvcReminderContext _context;

        public RemindersController(MvcReminderContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,DueDate,Priority")] Reminder reminder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,DueDate,Priority")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
